...
(Keys separated by /: tap for first, hold for second; uses Space Cadet Shifts)
 ...
 |        |        |    Z   |    X   |    C   |    V   |    B   |  ESC   |        |   |        |        |   N    |    M   |    ,   |    .   |    /   |        |        |
 |--------+--------+--------+--------+--------+--------+--------+--------+--------|   |--------+--------+--------+--------+--------+--------+--------+--------+--------|
 |   Del  |        |        |        |PrntScrn| Ctrl   | Bkspc  |Meta/OS | Shift  |   |  Shift |  Alt   | Space  | Ctrl   |        |        |   -    |        |        |
 `--------------------------------------------------------------------------------'   `--------------------------------------------------------------------------------'
*/
[_QWERTY] = LAYOUT(
  ...
  KC_DEL,  _______,  _______, _______, KC_PSCR, KC_LCTL, KC_BSPC, KC_LGUI, KC_LSFT,   KC_RSFT, KC_RALT, KC_SPC,  KC_RCTL, _______, _______, KC_MINS, _______, _______ //KC_CTL shoudl be double tap for capslock
),
...
[_FUNC] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______, KC_DEL,  _______, _______,     _______, _______, _______, _______, _______, _______, KC_PIPE, _______, _______
),
